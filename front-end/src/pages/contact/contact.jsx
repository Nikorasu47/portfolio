    ...
    <section className="contact">
      ...
      <div className="contact__right">
        <div className="contact__info">
          <h2><FontAwesomeIcon icon={faEnvelope} /><strong>Mail :</strong></h2> 
          <a href="mailto:nicolas.fort@email.com">nicolas.fort@email.com</a>
        </div>
        <div className="contact__info">
          <h2><FontAwesomeIcon icon={faPhone} /><strong>Téléphone :</strong></h2> 
          <a href="tel:+33685990819">06 85 99 08 19</a>
        </div>
        <div className="contact__address">
          <h2><FontAwesomeIcon icon={faLocationDot} /><strong>Adresse :</strong></h2> 
          <a
